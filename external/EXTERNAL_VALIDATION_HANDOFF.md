# External Validation Handoff — Operating Notes
...
- results_return.csv per the template: their run version, data description,
  measured metrics, responsible person, and permission basis.
- Their own work log entries covering actual execution.

## Blank fact sheet (external/results_return_template.csv)
Fields: run_version, data_source, data_description, mapping_doc,
responsible_person, capacity_basis, metrics_json, execution_date,
...
- The system defaults to no outreach, no email, no registration, no
  submission and no payment until explicitly authorized.
